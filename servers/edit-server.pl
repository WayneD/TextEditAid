...
Options:
--port=N, -p      Change the port we listen on (default: $PORT)
--no-auth         Override the default requirement for a username & password.
--verbose, -v     Increase debug verbosity (repeatable)
